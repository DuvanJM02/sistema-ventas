...
@section('container')
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <h3>Lista de clientes <a class="btn btn-success" href="{{ route('cliente.create') }}">Nuevo</a></h3>
                ...
                <table class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    @foreach ($personas as $persona)
                        <tr>
                            ...
                            <td>{{ $persona->email }}</td>
                            <td>
                                <a class="btn btn-warning" href="{{ route('cliente.edit', $persona->idpersona) }}">editar</a>
